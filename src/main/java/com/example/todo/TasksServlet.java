...
public class TasksServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        Task created = dao.create(
                new Task(received.getTitle().trim(), received.isCompleted()));
     ...
     * Logs and sets a 500 status if the write itself fails.
     *
     * @param resp    the HTTP response
    ...
    /**
     * Parses a {@link Task} for an update operation. Reads from JSON body,
     * form parameters, or query-string fallback.
     *
     * @param req the HTTP request
    ...
    /**
     * Resolves title and completed parameters from the request, falling back
     * to manual query-string parsing when standard parameters are empty.
     *
     * @param req the HTTP request
    ...
    /**
     * Builds a {@link Task} by merging the provided parameter values with the
